...
\theorembodyfont{\normalfont}
\theoremstyle{break}
\def\theoremframecommand{{\color{blue!70!black}\vrule width 5pt \hspace{5pt}}}
...
\theorembodyfont{\normalfont}
\theoremstyle{break}
\def\theoremframecommand{{\color{gray!55}\vrule width 5pt \hspace{5pt}}}
...
\theorembodyfont{\normalfont}
\theoremstyle{break}
\def\theoremframecommand{{\color{gray!20}\vrule width 5pt \hspace{5pt}}}
