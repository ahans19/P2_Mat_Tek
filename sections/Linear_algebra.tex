...
In practice orthogonal bases are often normalised to obtain an orthonormal basis of the same subspace. A matrix which rows forms a orthonormal set is called an orthogonal matrix.
